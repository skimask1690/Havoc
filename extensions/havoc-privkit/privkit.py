...
def alwaysinstallelevated( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "alwaysinstallelevated.o", b'', False)
...
def autologon( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "autologon.o", b'', False)
...
def credentialmanager( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "credentialmanager.o", b'', False)
...
def hijackablepath( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "hijackablepath.o", b'', False)
...
def modifiableautorun( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "modifiableautorun.o", b'', False)
...
def tokenprivileges( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "tokenprivileges.o", b'', False)
...
def unquotedsvcpath( demonID, *param ):
    ...
    demon.InlineExecute(TaskID, "go", "unquotedsvcpath.o", b'', False)
